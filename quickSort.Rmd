...
We can conclude from this that the machine in which we run the experiments actually impacts the results a lot, so we will now merge the data from both machines to reduce the impact of the machine on the results
...
```
This is much better than the result of the original 
